...
Graf_random_uni =  random_relations_uniform_graph(50,50)
Graf_ba_uni = ba_opinion_uniform_graph()
Graf_hk_uni = hk_opinion_uniform_graph()
Graf_ws_uni = ws_opinion_uniform_graph()
Graf_sbm_uni = sbm_opinion_uniform_graph()

print('Gen, af grafer med polart holdninger')
Graf_random_polar =  random_relations_polar_graph(50,50)
Graf_ba_polar = ba_opinion_polar_graph()
Graf_ws_polar = ws_opinion_polar_graph()
Graf_hk_polar = hk_opinion_polar_graph()
Graf_sbm_polar = sbm_opinion_polar_graph()
